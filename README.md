# Python: Lectura de archivo Excel, con la librería 'openpyxl'

Aprende a leer un archivo Excel usando un script de Python, de una forma sencilla, fácil y directa. Conoce cómo extraer y procesar los datos de un libro de Excel con Python, usando el paquete 'openpyxl'.
